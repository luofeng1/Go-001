...
// 	protoc        v3.11.4
// source: Week04/api/user/v1/user.proto
...
func (x *RegisterUserRequest) Reset() {
	*x = RegisterUserRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_Week04_api_user_v1_user_proto_msgTypes[0]
...
func (*RegisterUserRequest) Descriptor() ([]byte, []int) {
	return file_Week04_api_user_v1_user_proto_rawDescGZIP(), []int{0}
}
...
func (x *RegisterUserReply) Reset() {
	*x = RegisterUserReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_Week04_api_user_v1_user_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RegisterUserReply) Descriptor() ([]byte, []int) {
	return file_Week04_api_user_v1_user_proto_rawDescGZIP(), []int{1}
}
...
var File_Week04_api_user_v1_user_proto protoreflect.FileDescriptor

var file_Week04_api_user_v1_user_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x57, 0x65, 0x65, 0x6b, 0x30, 0x34, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x75, 0x73, 0x65,
...
var (
	file_Week04_api_user_v1_user_proto_rawDescOnce sync.Once
	file_Week04_api_user_v1_user_proto_rawDescData = file_Week04_api_user_v1_user_proto_rawDesc
)

func file_Week04_api_user_v1_user_proto_rawDescGZIP() []byte {
	file_Week04_api_user_v1_user_proto_rawDescOnce.Do(func() {
		file_Week04_api_user_v1_user_proto_rawDescData = protoimpl.X.CompressGZIP(file_Week04_api_user_v1_user_proto_rawDescData)
	})
	return file_Week04_api_user_v1_user_proto_rawDescData
}

var file_Week04_api_user_v1_user_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_Week04_api_user_v1_user_proto_goTypes = []interface{}{
	(*RegisterUserRequest)(nil), // 0: user.v1.RegisterUserRequest
	(*RegisterUserReply)(nil),   // 1: user.v1.RegisterUserReply
}
var file_Week04_api_user_v1_user_proto_depIdxs = []int32{
...
func init() { file_Week04_api_user_v1_user_proto_init() }
func file_Week04_api_user_v1_user_proto_init() {
	if File_Week04_api_user_v1_user_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_Week04_api_user_v1_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_Week04_api_user_v1_user_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_Week04_api_user_v1_user_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_Week04_api_user_v1_user_proto_goTypes,
		DependencyIndexes: file_Week04_api_user_v1_user_proto_depIdxs,
		MessageInfos:      file_Week04_api_user_v1_user_proto_msgTypes,
	}.Build()
	File_Week04_api_user_v1_user_proto = out.File
	file_Week04_api_user_v1_user_proto_rawDesc = nil
	file_Week04_api_user_v1_user_proto_goTypes = nil
	file_Week04_api_user_v1_user_proto_depIdxs = nil
}
...
var _User_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "Week04/api/user/v1/user.proto",
}
